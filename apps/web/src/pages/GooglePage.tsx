                    ...
                    {googleSheet?.spreadsheetUrl ? (
                        <div className="mt-4 space-y-2">
                            <a
                                ...
                                className="block w-full py-2.5 text-center bg-success text-success-content font-medium rounded-xl transition-colors"
                            >
                                Buka Spreadsheet
                            </a>
                        ...
                        <button
                            className="mt-4 w-full py-2.5 text-center bg-base-200 text-base-content font-medium rounded-xl transition-colors"
                            onClick={() => {
                ...
                <div className="bg-base-100 rounded-2xl p-4">
                    ...
                    {googleFolder?.folderUrl ? (
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="mt-4 block w-full py-2.5 text-center bg-warning text-warning-content font-medium rounded-xl transition-colors"
                        >
                            Buka Folder Invoice
                        </a>
                    ) : (
                ...
                <div className="bg-info/10 rounded-2xl p-4 border border-info/20">
                    ...
                    <div className="mt-3 space-y-2 text-sm">
                        <div className="flex justify-between">
                            ...
                            <span className={googleSheet ? "text-success" : "text-base-content"}>
                                {googleSheet ? "✓ Terhubung" : "Belum terhubung"}
                            </span>
                        </div>
                        <div className="flex justify-between">
                            <span className="text-base-content">Google Drive</span>
                            <span className={googleFolder ? "text-success" : "text-base-content"}>
